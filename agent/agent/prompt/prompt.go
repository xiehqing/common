...
import (
	...
	"github.com/xiehaiqing/common/agent/skills"
	"os"
	"path/filepath"
	"runtime"
	"strings"
...
func (p *Prompt) Build(ctx context.Context, provider, model string, cfg config.Config, additionalSystemPrompt string) (string, error) {
	...
	prompt := fmt.Sprintf("%s\n%s", sb.String(), additionalSystemPrompt)
	return prompt, nil
}
